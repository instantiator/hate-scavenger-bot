...
class TestFilterData(unittest.TestCase):
    ...
    def test_can_extract_data_from_json_string(self):
        ...
        keys =  ["id", "created_at", "text", "lang", "retweet_count", "favorite_count", "geo", "place", ("entities", "hashtags")]
